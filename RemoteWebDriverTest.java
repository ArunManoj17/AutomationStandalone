...
//System.getProperty("172.17.110.12");
...
//Map<String, ObjMap<String, Object> params12 = new HashMap<>();
//params12.put("location", "1134,1591");
//Object result12 = driver.executeScript("mobile:touch:tap", params12);

//ect> params11 = new HashMap<>();
//params11.put("location", "1152,1509");
...
driver.findElementByXPath("//*[@id=\"userName\"]").sendKeys("12345");

switchToContext(driver, "WEBVIEW");
driver.findElementByXPath("//*[@id=\"passWord\"]").sendKeys("Jan@1234");

switchToContext(driver, "WEBVIEW");
driver.findElementByXPath("//*[@class=\"btn login-button\"]").click();
